...
import { adaptParams } from './objUtil';
...
export default (cParams) => {
	...
	const setBoard = (params) => {
		...
		args.values = pickBy((val) => !isNil(val), args.values);
	 ...
	 * @param {Function} [params.callback] the callback function once the
	 * operation is complete
	 * @return {Object} a Promise that resolves to an action object representing
	 * the new comment
	 */
	 ...
	 * @param {Function} [params.callback] the callback function once the
	 * operation is complete
	 * @return {Object} a Promise that resolves to a card object representing
	 * then new card
	 */
	 ...
	 * @param {Function} [params.callback] the callback function once the
	 * operation is complete
	 * @return {Object} a Promise that resolves to the label object
	 */
