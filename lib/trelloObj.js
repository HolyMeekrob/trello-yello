...
const constructor = function (cParams) {
	...
	const { objMaps, objType, config, id, net, initialVals } = cParams;
	 ...
	 * @return {Object} a Promise that resolves to the object returned by the
	 * Trello API
	 */
	 ...
	 * @return {Object} a Promise that resolves with the data returned by Trello.
	 */
	const get = (params) => {
	 ...
	 * @param {String} [params.property] the property to delete. If this is not
	 ...
	 */
	const del = (params) => {
		const { property, callback } = params;
